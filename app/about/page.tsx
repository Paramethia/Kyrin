	...
	return (
		<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="sm:flex sm:justify-center sm:items-center sm:h-full">
			<div className="text-center md:text-start space-y-6 max-w-2xl relative mx-4 md:mx-0">
				<motion.h1 initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2, duration: 0.5 }} className="tit about-kyrin text-4xl text-gray-700 dark:text-gray-100 font-bold">
					About Kyrin
				</motion.h1>
				...
				<motion.div initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.6, duration: 0.5 }} className="space-y-6">
					<div className="p-6 border border-gray-700/20 rounded-xl backdrop-blur-sm hover:border-gray-700/50 transition-colors duration-300">
						<h2 className="text-2xl text-gray-600 dark:text-gray-200 font-semibold mb-2">Me</h2>
					...
					<div className="p-6 border border-gray-700/20 rounded-xl backdrop-blur-sm hover:border-gray-700/50 transition-colors duration-300">
						<h2 className="text-2xl text-gray-600 dark:text-gray-200 font-semibold mb-2">Journey as a developer</h2>
						<p className="text-gray-600 dark:text-gray-400 mb-4">
